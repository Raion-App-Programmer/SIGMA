'use strict';
/* build-hook-start *//*00001*/try { require('c:\\Users\\ROBI\\.vscode\\extensions\\wallabyjs.console-ninja-1.0.460\\out\\buildHook\\index.js').default({tool: 'jest', checkSum: '204c48a83b29a69f5b54b2BloaD08ICQAHCQdTXQdUUFRXVFMH', mode: 'build'}); } catch(cjsError) { try { import('file:///c:/Users/ROBI/.vscode/extensions/wallabyjs.console-ninja-1.0.460/out/buildHook/index.js').then(m => m.default.default({tool: 'jest', checkSum: '204c48a83b29a69f5b54b2BloaD08ICQAHCQdTXQdUUFRXVFMH', mode: 'build'})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
